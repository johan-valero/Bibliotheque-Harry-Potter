...
# ##################################
  ...
  def ImporterLivre(self):
    with open("database/livres.txt", mode='r', encoding="utf-8") as f:
  ...
  def ImporterUser(self):
    with open("database/utilisateurs.txt", mode='r', encoding="utf-8") as f:
      for line in f.readlines():
        split_line = line.split(';')
  ...
  def ExporterLivre(self):    
    with open("database/livres.txt", mode='w', encoding="utf-8") as f:
      for i in self.livre_liste:
        chaine = i.titre + ";" + i.auteur + ";" + i.langue + ";" + i.genre + ";" + i.categorie + ";" + i.ref + ";" + i.dispo + ";" + i.retour + "\n"
        f.write(chaine)
